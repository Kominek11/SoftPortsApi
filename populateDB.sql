...
INSERT INTO public.tarefa (id, titulo, descricao, so, screenshots, caminho, data_correcao, data_criacao, prioridade, classificacao, status, projeto_id) VALUES
(nextval('tarefa_id_seq'), 'Corrigir bug na tela de login', 'Corrigir o erro de autenticação na tela de login', 'Windows', 'screenshot1.png', '/caminho/correcoes', '2024-08-22', '2024-08-21', 1, 1, 1, 1),
(nextval('tarefa_id_seq'), 'Implementar nova funcionalidade', 'Adicionar a funcionalidade de exportação de relatórios', 'Linux', NULL, NULL, NULL, '2024-08-20', 2, 2, 2, 2),
(nextval('tarefa_id_seq'), 'Melhorar desempenho do sistema', 'Otimizar a consulta ao banco de dados', 'MacOS', 'screenshot2.png', '/caminho/melhorias', '2024-08-23', '2024-08-21', 1, 1, 1, 3),
(nextval('tarefa_id_seq'), 'Atualizar documentação', 'Atualizar a documentação do sistema para a versão mais recente', NULL, NULL, '/caminho/documentacao', NULL, '2024-08-21', 3, 2, 2, 4),
(nextval('tarefa_id_seq'), 'Corrigir erro na exportação de dados', 'Corrigir o erro ao exportar dados no formato CSV', 'Windows', 'screenshot3.png', '/caminho/correcoes2', '2024-08-25', '2024-08-21', 2, 3, 3, 5);
